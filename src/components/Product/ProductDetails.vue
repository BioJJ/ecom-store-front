...
<template>
	<section class="app-section">
		<div class="wrapper">
			<!-- Product Details -->
			<div class="flex flex-col gap-8 lg:col-span-4 lg:flex-row">
				<!-- Product Images -->
...
.img {
	@apply mx-auto mb-4 h-[500px] w-[500px];
}
.product-image-swiper {
	...
	.swiper-button-next,
	.swiper-button-prev {
		@apply flex items-center justify-center rounded-full p-1 transition-colors;
